...
TEST(BreakOutStrategy, smoke_test)
{
    ...
    env << "QUOTE askPrice=100.0 askSize=100.0 bidPrice=98.0 bidSize=1000.0 symbol=XBTUSD" LN;
    env >> "ORDER_NEW ordStatus=New orderQty=100 price=98 side=Buy symbol=XBTUSDorderID=1 clOrdID=MCST0 " LN;
    env >> "NONE" LN;
